...
```zsh
imessage-exporter -f txt -o output -c compatible
```
...
```zsh
imessage-exporter -f html -c compatible -p /Volumes/external/chat.db -r /Volumes/external/Attachments -o /Volumes/external/export
```
...
```zsh
imessage-exporter -f html -c compatible -t "5558675309"
```
